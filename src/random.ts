...
export const randomNumber = (min: number = 0, max: number = Number.MAX_SAFE_INTEGER): number => min + Math.floor(Math.random() * (max - min + 1))

export const randomElement = (array: any[]) => array[randomNumber(0, array.length - 1)]
